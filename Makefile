...
LIB_SOURCES = Instruction.cpp LineLevelParser.cpp MiniPython.cpp Scope.cpp StandardFunctions.cpp Token.cpp TokenToVariable.cpp StringFormatting.cpp RaiseException.cpp Parser.cpp Utils.cpp ../modules/os.cpp ../modules/sys.cpp ../modules/time.cpp ../modules/math.cpp ../modules/binascii.cpp
