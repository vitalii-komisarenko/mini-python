...
def generate_for_arithmetic_operation(operation, cpp_variable_method_name, fh):
    orig_stdout = sys.stdout
    sys.stdout = fh

    test_class_name = f"Variable{cpp_variable_method_name.capitalize()}Test"

    print('#include "variable/Variable.h"')
    print()
